...
export default function CertificatesPage() {
  ...
  const [openPdfCardId, setOpenPdfCardId] = useState(null);
  ...
  const openEditModal = (certificate) => {
    ...
    setImagePreview(isPdf(certificate.image) ? '' : certificate.image);
            ...
            {certificates.map((certificate, index) => (
              ...
              <div className="aspect-video bg-gray-200 relative flex items-center justify-center">
                {isPdf(certificate.image) ? (
                  openPdfCardId === certificate._id ? (
                    <div className="w-full h-full relative flex flex-col">
                      <object data={certificate.image} type="application/pdf" className="w-full h-full">
                        <div className="p-4 text-center text-sm text-gray-700">
                          Unable to preview PDF. 
                          <a href={certificate.image} target="_blank" rel="noopener noreferrer" className="text-blue-600 underline">Open in new tab</a>
                      ...
                      <div className="absolute top-2 left-2 flex gap-2">
                        <a
                          ...
                          className="px-2 py-1 bg-white/80 hover:bg-white text-gray-800 rounded-md text-xs"
                        >
                          Open in new tab
                        </a>
                        <a
                    ...
                    <div className="flex flex-col items-center justify-center text-gray-700">
                      <svg className="w-12 h-12 text-red-500 mb-3" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true">
                        <path d="M4 2a2 2 0 00-2 2v12a2 2 0 002 2h8.586A2 2 0 0014 17.414L17.414 14A2 2 0 0018 12.586V4a2 2 0 00-2-2H4zM5 6h10v2H5V6zm0 4h7v2H5v-2z" />
                      </svg>
                      <button
                        type="button"
                        onClick={() => setOpenPdfCardId(certificate._id)}
                  ...
                  <img
                    ...
                    onError={(e) => {
                      e.target.src = 'data:image/svg+xml;base64,';
                    }}
                  />
                )}
                {isPdf(certificate.image) && openPdfCardId === certificate._id && (
                  <button
                    type="button"
                    onClick={() => setOpenPdfCardId(null)}
                    className="absolute top-2 right-2 bg-white/80 hover:bg-white text-gray-800 rounded-md px-2 py-1 text-xs"
                  >
                    Close
                  </button>
                )}
                  ...
                  <div>
                    ...
                    <div className="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-lg hover:border-green-400 transition-colors duration-200">
                      <div className="space-y-1 text-center">
                        ...
                        ) : formData.image && isPdf(formData.image) ? (
                          <div className="relative flex flex-col items-center">
                            <svg className="mx-auto h-12 w-12 text-red-500" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true">
                              <path d="M4 2a2 2 0 00-2 2v12a2 2 0 002 2h8.586A2 2 0 0014 17.414L17.414 14A2 2 0 0018 12.586V4a2 2 0 00-2-2H4zM5 6h10v2H5V6zm0 4h7v2H5v-2z" />
                            </svg>
                            <span className="text-sm text-gray-700 mt-2">PDF selected</span>
                            <button
                              type="button"
                              onClick={() => {
                                setImagePreview('');
                              ...
                              className="mt-2 bg-red-500 text-white rounded-full w-6 h-6 flex items-center justify-center text-xs hover:bg-red-600 transition-colors"
                            >
                              ×
                            </button>
                          </div>
              ...
              <div className="p-6">
                ...
                <div className="space-y-4">
                  <div className="aspect-video bg-gray-200 rounded-xl overflow-hidden flex items-center justify-center">
                    {isPdf(selectedCertificate.image) ? (
                      <iframe src={selectedCertificate.image} className="w-full h-full" title="Certificate PDF" />
                    ) : (
                      <img
